              ...
              <Container>
                <Card style={{ width: '18rem' }} className="p-3 mb-2 text-black details-item-card">
                  <Card.Body>
                    ...
                    <Card.Text>
                      {DateTime.fromISO(detail.date).toLocaleString(DateTime.DATETIME_MED)}
                    </Card.Text>
                    <Card className="pt-2 pb-2 extra-details-card">
                      ...
                      <Card.Text>
                        Music Director:
                        {detail.music_director}
                      </Card.Text>
                      <Card.Text>
                        Choreographer:
                        {detail.choreographer}
                      </Card.Text>
                      <Card.Text>
                        Casting Director:
                        {detail.casting_director}
                      </Card.Text>
                      <Card.Text>
                        Pianist:
                        {detail.pianist}
                      ...
                      <Card.Text>
                        Audition Complete?
                        {detail.audition_complete ? 'Yes' : 'No'}
                      </Card.Text>
                      <Card.Text>
                        Callback?
                        {detail.callback ? 'Yes' : 'No'}
                      </Card.Text>
                      <Card.Text>
                        Booked?
                        {detail.booked ? 'Yes' : 'No'}
                      </Card.Text>
                      <Card.Text>
                        Notes:
                        {detail.notes}
