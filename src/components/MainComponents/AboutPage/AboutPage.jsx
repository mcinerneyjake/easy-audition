...
function AboutPage() {
  return (
    <div className="about-container">
      ...
      <Card className="mt-5">
        <Card.Text style={{ fontSize: '2rem' }} className="about-card-text">
          Easy Audition is the app for actors to take control of their careers,
          analyze their auditions, and book more gigs!
        </Card.Text>
      </Card>
      <a href="https://github.com/mcinerneyjake" aria-label="https://github.com/mcinerneyjake">
